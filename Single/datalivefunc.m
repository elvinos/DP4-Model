function [cumSavyear,Year,Saving,pbtime,SavingPY,DoDmean,disTmean,cycle] = datalivefunc(liveDataSelc,sdate,UFCost, newCap, maxPower)
...
while curCap > endlifeval || n == runlen*365
