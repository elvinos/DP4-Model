function [cumSavyear,Year,Saving,pbtime,SavingPY,DoDmean,disTmean,accycle] = dlivsgforfunc(liveDataSelc,sdate,UFCost, newCap, maxPower)
...
perCycleDeg=(newCap-endlifeval)/noCycles;
use= 0;
cycle = 0;
